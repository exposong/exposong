...
class PresList(gtk.TreeView, exposong._hook.Menu):
    ...
    def activate_pres(self, *args):
        ...
        pres_delete.set_sensitive(self.has_selection() and self.get_model(True).builtin)
        pres_remove.set_sensitive(self.has_selection() and not self.get_model(True).builtin)
