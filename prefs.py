...
class Prefs(gtk.Dialog):
	def __init__(self, parent):
		...
		self.vbox.pack_start(self.section_title("Background"), True, True, 5)
		self.vbox.pack_start(self.color_pref("Gradiant Top-Left", parent.config['pres.bg'][0], name='bg_tlf'), False, False, 5)
		self.vbox.pack_start(self.color_pref("Gradiant Bottom-Right", parent.config['pres.bg'][1], name='bg_brt'), False, False, 5)
		self.vbox.pack_start(self.section_title("Font"), True, True, 5)
		self.vbox.pack_start(self.color_pref("Text Color", parent.config['pres.text_color'], name='txt_color'), False, False, 5)
		self.vbox.pack_start(self.color_pref("Text Shadow", parent.config['pres.text_shadow'], True, name='txt_shadow'), False, False, 5)
	...
	def spinner_pref(self, title, value, name=None):
		...
		spinner = gtk.SpinButton(None, 3.0, 0)
